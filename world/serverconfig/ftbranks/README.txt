...
Last README file update: Sun Oct 13 21:48:06 MSK 2024
...
command.blockwall
command.blockwall.pos
command.blockwall.pos.pos
command.bookshelf
...
command.frostedheart.research.energy
command.frostedheart.research.energy.add
command.frostedheart.research.energy.add.amount
...
command.frostedheart.temperature.get.position
command.frostedheart.temperature.set
command.frostedheart.temperature.set.position
command.frostedheart.temperature.set.position.range
command.frostedheart.temperature.set.position.range.temperature
command.ftbbackups
...
command.givealloy.targets.item.composition
command.givealloy.targets.item.composition.recipe
command.givealloy.targets.item.composition.recipe.count
command.givealloy.targets.item.composition.recipe.count.modifier
command.givealloy.targets.item.composition.recipe.count.modifier.color
command.help
...
command.locate.frostedheart:observatory
